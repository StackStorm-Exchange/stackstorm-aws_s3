...
1. Install the [aws_stackstorm-aws_s3 pack](https://github.com/stackstorm-exchange/stackstorm-aws_stackstorm-aws_s3):

    ```
    # Install AWS
    st2 pack install aws_stackstorm-aws_s3

    # Check it
    st2 action list -p aws_stackstorm-aws_s3
    ```

2. Copy the example configuration in [aws.yaml.example](./aws.yaml.example)
to `/opt/stackstorm/configs/aws_stackstorm-aws_s3.yaml` and edit as required. It must contain:
...
Prior to installation of the aws pack, you can get the list of available actions here:
  ...
  https://github.com/StackStorm-Exchange/stackstorm-aws_stackstorm-aws_s3/tree/master/actions
...
```
source /opt/stackstorm/virtualenvs/aws_stackstorm-aws_s3/bin/activate
cd /opt/stackstorm/packs/aws_stackstorm-aws_s3/etc/st2packgen
python st2packgen.py -d /opt/stackstorm/packs/aws_stackstorm-aws_s3/actions
st2ctl reload --register-actions
```

`st2packgen.py` will overwrite any existing actions at `/opt/stackstorm/packs/aws_stackstorm-aws_s3/actions`.
